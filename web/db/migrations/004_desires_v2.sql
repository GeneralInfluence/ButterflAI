...
ALTER TABLE desires ADD COLUMN candidate_ids TEXT;           -- JSON array of contact UUIDs
...
ALTER TABLE desires ADD COLUMN recurrence_end TEXT;         -- YYYY-MM-DD or null if ongoing

-- horizon: 'one_off' | 'recurring' | 'template'
-- template = parent recurring desire, one_off = instance or standalone
ALTER TABLE desires ADD COLUMN horizon TEXT NOT NULL DEFAULT 'one_off';
ALTER TABLE desires ADD COLUMN parent_desire_id TEXT;       -- links instance back to its template
